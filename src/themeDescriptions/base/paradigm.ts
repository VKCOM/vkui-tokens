...
export const lightColors: ColorsDescription = {
	...
	colors: {
		...
		colorTextPrimaryAlpha: 'rgba(0, 0, 0, 0.84)',
		...
		colorTextSubheadAlpha: 'rgba(61, 68, 77, 0.71)',
		colorTextTertiary: '#AAADB3',
		colorTextTertiaryAlpha: 'rgba(35, 39, 43, 0.44)',
...
export const darkColors: ColorsDescription = {
	...
	colors: {
		...
		colorTextSubheadAlpha: 'rgba(241, 247, 255, 0.58)',
		colorTextTertiary: '#74767A',
		colorTextTertiaryAlpha: 'rgba(244, 250, 255, 0.31)',
		colorTextLinkVisited: '#528FDF',
		colorTextContrast: '#FFFFFF',
