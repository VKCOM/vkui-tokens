...
export const octaviusTheme: ThemeOctaviusDescription = {
	...
	colors: {
		...
		colorPaletteOrange1Alpha: toneOpacity('#FF9E00', 0.12),
		...
		colorPaletteGreen1Alpha: toneOpacity('#5CBA38', 0.12),
		colorPaletteGreen2Alpha: toneOpacity('#00E6B4', 0.08),
		colorPaletteBlue1: '#2951ff',
		colorPaletteBlue2: '#00abf2',
		colorPaletteBlue3: '#26dfdf',
		colorPaletteBlue1Alpha: toneOpacity('#005FF9', 0.12),
		...
		colorTagBackgroundPink2: '#FF54AA',
		colorTagTextPink2: '#FFFFFF',
		colorTagBackgroundTeal: '#13B4BF',
		colorTagTextTeal: '#FFFFFF',
		colorTagBackgroundCyan: '#07E5F9',
		colorTagTextCyan: '#FFFFFF',
		colorTagBackgroundBlue: '#5A9EFF',
		colorTagTextBlue: '#FFFFFF',
		colorTagBackgroundOrange2: '#FF9E00',
		colorTagTextOrange2: '#FFFFFF',
		colorTagBackgroundRed: '#FC2C38',
		colorTagTextRed: '#FFFFFF',
		colorTagBackgroundViolet2: '#C15DF3',
		colorTagTextViolet2: '#FFFFFF',
		colorTagBackgroundPurple2: '#8C64FF',
		colorTagTextPurple2: '#FFFFFF',
		colorTagBackgroundGreen: '#0DC268',
		colorTagTextGreen: '#FFFFFF',
