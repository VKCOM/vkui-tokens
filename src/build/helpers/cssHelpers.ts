...
export function isColorDescriptionCallable(value: unknown): value is ColorDescriptionCallable<any> {
	return typeof value === 'function';
}

export function isColorDescriptionStatic(value: unknown): value is ColorDescriptionStatic {
 ...
 * TODO: remove
 */
export function getRGBA(color: ColorDescription, opacity: number): ColorDescription {
...
export function toneOpacity(color: ColorDescription, opacity: number): ColorDescription;
export function toneOpacity(color: ColorDescription, opacity: number): ColorDescription {
